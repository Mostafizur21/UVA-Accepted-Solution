...
int main()
{
    ...
    int test,R,t,lenght,width,left_lenght,right_length,mid_width;
    sc1(test);
    rep(t,test)
    {
        sc1(R);
        ...
        width = R*3;
        mid_width = width/2;
        left_lenght = (lenght*45)/100;
        right_length = lenght-left_lenght;
        printf("Case %d:\n",t);
        printf("-%d %d\n",left_lenght,mid_width);
        printf("%d %d\n",right_length,mid_width);
        printf("%d -%d\n",right_length,mid_width);
        printf("-%d -%d\n",left_lenght,mid_width);
    }
    return 0;
